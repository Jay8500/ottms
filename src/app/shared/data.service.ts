...
import {
  AppUser, Badge, BadgeAward, Category, ChatMessage, ChatThread, CommerceOption,
  FaqItem, FormField, GroupScreen, HomeButton, LangCode, Localized, OttApp,
  PaymentConfig, Referral, SocialLink, UserRating, ValidityPlan, WalletSummary,
  WalletTx,
} from './models';
...
export class DataService {
  ...
  exitMembership(memberId: string, reason: 'personal' | 'faulty', proofUrl?: string) {
    return this.sb.rpc('exit_membership', { p_member: memberId, p_reason: reason, p_proof_url: proofUrl ?? null });
  }
