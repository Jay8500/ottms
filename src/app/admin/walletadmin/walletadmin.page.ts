...
export class WalletadminPage implements OnInit {
  ...
  allWallets = [
    ...
    },
    {
      ...
      unlocked: '2,400',
      role: 'Seller',
      screens: ['Prime 1M Sold', 'ZEE5 1M Sold'],
    },
    {
      id: 'u3',
      name: 'Arjun',
  ...
  filterWallets() {
    ...
    this.filteredWallets = !t
      ? [...this.allWallets]
      : this.allWallets.filter(
          (w) => w.name.toLowerCase().includes(t) || String(w.uid).includes(t)
        );
  }
      ...
      inputs: [
        {
          name: 'total',
          type: 'number',
          value: w.total.replace(',', ''),
          placeholder: 'Total Amount',
        },
        {
          name: 'locked',
          type: 'number',
          value: w.locked.replace(',', ''),
          placeholder: 'Locked Amount',
        },
        {
          name: 'unlocked',
          type: 'number',
          value: w.unlocked.replace(',', ''),
