...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'groups',       loadComponent: () => import('../groups/groups.page').then(m => m.UserGroupsPage) },
      { path: 'terms',        loadComponent: () => import('../terms/terms.page').then(m => m.UserTermsPage) },
      { path: 'refer',        loadComponent: () => import('../refer/refer.page').then(m => m.UserReferPage) },
